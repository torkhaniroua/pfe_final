...
public class RegistrationController 
{
	...
	public User registerUser(@RequestBody User user) throws Exception
	{
		...
		try {
			emailService.sendAccountCreationEmail(userObj.getEmail(), userObj.getUsername(), frontendLoginUrl);
	...
	public Professor registerDoctor(@RequestBody Professor professor) throws Exception
	{
		...
		try {
			emailService.sendAccountCreationEmail(professorObj.getEmail(), professorObj.getProfessorname(), frontendLoginUrl);
		} catch (Exception ignored) {}
		return professorObj;
	}
